    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div className="bg-green-50 rounded-xl p-4 flex items-center justify-between relative overflow-hidden border border-green-100 h-28">
        <div className="z-10 w-1/2">
          ...
          <button className="bg-white border border-green-200 text-green-700 text-xs font-medium px-3 py-1 rounded-md hover:bg-green-100 transition-colors">
            ช้อปเลย
          </button>
        </div>
        <div className="absolute right-[-10px] bottom-[-10px] w-28 h-28">
          {/* Use a placeholder since I don't have the exact image */}
      ...
      <div className="bg-amber-50 rounded-xl p-4 flex items-center justify-between relative overflow-hidden border border-amber-100 h-28">
        <div className="z-10">
          ...
          <p className="text-amber-700 text-xs mb-3">สำหรับสมาชิก Level 20+</p>
          <div className="bg-white border border-amber-200 text-amber-800 text-[10px] font-medium px-2 py-0.5 rounded-md inline-block">
            ใช้โค้ด: GARDEN10
          </div>
        </div>
        <div className="absolute right-2 bottom-2 w-16 h-16 transform rotate-[-15deg]">
          <div className="w-full h-full bg-green-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">
            %
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-xl p-4 flex items-center justify-between relative overflow-hidden border border-blue-100 h-28 group cursor-pointer">
